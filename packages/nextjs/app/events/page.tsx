          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="table table-zebra">
                ...
                <tbody>
                  {currentEvents.slice(0, 20).map((event: any, index) => (
                      ...
                      <td>
                        {eventType === "token" ? (
                          <span className="font-mono">
                            {Number(formatEther(event.args.value || 0n)).toFixed(4)} MTK
                          </span>
                        ) : (
                          <span className="badge badge-primary">#{event.args.tokenId?.toString()}</span>
                        )}
                      </td>
                      <td>
